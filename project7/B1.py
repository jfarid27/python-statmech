...
class MarkovChainHarmonicBosonSimulation():
    ...
    def runSimulation(self, T_star=0.7, N=64, nsteps=10000, readConfiguration=False, writeConfiguration=False):
...
if (__name__ == '__main__'):
    ...
    data = simulationInstance.runSimulation(T, nparticles, nsteps)
    simulationInstance.plot3dHistogramData(data, T, nparticles) 
